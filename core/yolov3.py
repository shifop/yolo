...
from core.yolov4 import DropBlock
...
class YOLOv3(tf.keras.Model):
    ...
    def __init__(self, config):
        ...
        self.dropblock1 = DropBlock(0.8, 12)
        self.dropblock2 = DropBlock(0.8, 6)
        self.dropblock3 = DropBlock(0.8, 3)
    ...
    def __call__(self, input, training):
        ...
        route_1 = self.dropblock1(route_1, training)
        route_2 = self.dropblock2(route_2, training)
        conv = self.dropblock3(conv, training)
